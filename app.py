...
@app.route('/play/memory', methods=['GET', 'POST'])
def play_memory():
    # For now, just render the memory game UI
    return render_template('memory.html')


@app.route('/play/currency', methods=['GET', 'POST'])
def play_currency():
    # For now, just render the currency game UI
